...
const PROJECTS = {
  ...
  QuantoVouGastar: {
    title: 'Calculadora Inteligente de Custos de Viagem',
    html: `
      <p><b class="text-[#00c7e5]">Desafio:</b> Empresas de logística e motoristas de aplicativo enfrentavam dificuldades para estimar com precisão os custos de combustível e pedágio nas viagens. Estimativas imprecisas resultavam em perda financeira, dificuldade no planejamento e na precificação de serviços.</p>
      <p><b class="text-[#00c7e5]">Solução:</b> Desenvolvemos uma aplicação web responsiva que integra a API do Google Maps para traçar rotas precisas e calcular custos de viagem em tempo real. O sistema permite cálculo de rotas múltiplas, cadastro de veículos com consumo personalizado (gasolina, álcool, GNV, diesel), estimativa de custo total baseada em distância e consumo, interface responsiva para desktop/tablet/mobile, e histórico de viagens para planejamento futuro.</p>
      <p><b class="text-[#00c7e5]">Impacto:</b> Economia de até 15% nos custos de viagem, redução de 30% no tempo de cálculo, e aumento de 40% na precisão das estimativas em comparação com cálculos manuais.</p>
      <p><b class="text-[#00c7e5]">Tecnologias:</b> JavaScript, Google Maps API, Firebase, HTML5/CSS3, Design Responsivo</p>
    `,
    link: '#'
  },
  CrudInteligente: {
    ...
    html: `
      ...
      <p><b class="text-[#00c7e5]">Solução:</b> O cliente apenas digita o nome e o valor do produtos para cadastrar no sistema</p>
      <p><b class="text-[#00c7e5]">Impacto:</b> Facilidade do cliente apenas escrever os dados do produto, sem a necessidade de clicar em botões</p>
      <p><b class="text-[#00c7e5]">Tecnologias:</b>.NET</p>
    `,
    link: '#'
  }
};
